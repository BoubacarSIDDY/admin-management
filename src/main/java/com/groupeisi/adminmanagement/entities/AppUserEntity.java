...
public class AppUserEntity {
    ...
    @OneToMany(mappedBy = "appUserEntity") // marque le côté propriétaire de la rélation et que mappedBy appUserEntity => colonne étrangère de AppUserDto dans ProduitDto
